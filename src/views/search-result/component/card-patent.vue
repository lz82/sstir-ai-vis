<template>
  <div class="card-patent-wrapper">
    <div class="author-container">
      <h3 class="author-title"><i class="iconfont iconzhuanli" style="color:#F56C6C;margin-right: 5px; font-size: 24px;"/>{{  keyword }} related patents</h3>
