<template>
  <div class="card-paper-wrapper">
    <div class="author-container">
      <h3 class="author-title"><i class="iconfont iconlunwentimu" style="color:#F56C6C;margin-right: 5px; font-size: 24px;"/>{{  keyword }} related articles</h3>
